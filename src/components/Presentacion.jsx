    ...
    <div className='pres'>
        <section className='fondo'>
            <div className="pres-cont animado">
                <section>
                    <h1 className='txt-tit'>Mi Portafolio</h1>
                    ...
                    <div>
                        ...
                        <section>
                            ...
                            <nav>
                                {com("Github","https://github.com/Michel-exe",<TbBrandGithub/>)}
                                {com("Facebook","https://www.facebook.com/MichelHernandez521/",<FaFacebookF/>)}
                                {com("Instagram","https://www.instagram.com/michel.css/",<GrInstagram/>)}
